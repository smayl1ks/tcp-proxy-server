...
{
    if (!isOpen()) {
        throw std::runtime_error("connect error (socked is closed)");
    }
...
{
    if (!isOpen()) {
        throw std::runtime_error("send error (socked is closed)");
    }
...
{
    if (!isOpen()) {
        throw std::runtime_error("recv error (socked is closed)");
    }
